...
type ApplicationActionsPausePlayButtonProps = {
  pause: boolean;
  loading: boolean;
} & Omit<ButtonRootProps, 'children'>;

function ApplicationActionsPausePlayButton({ pause, loading, ...props }: ApplicationActionsPausePlayButtonProps) {
...
export default ApplicationActionsPausePlayButton;
